...
namespace CGame.Localization.Editor
{
    public class LanguageTextSOEditorWindow : EditorWindow
    {
        ...
        {
            var path = EditorUtility.OpenFilePanel(nameof(ImportCsvFile), Application.dataPath, _config.stringExternalLoader.CsvFileInfo.fileExtension[1..]);
        ...
        {
            var path = EditorUtility.OpenFilePanel(nameof(ImportCsvFile), Application.dataPath, _config.stringExternalLoader.ExcelFileInfo.fileExtension[1..]);
            if (string.IsNullOrWhiteSpace(path))
                return;
        ...
        {
            var path = EditorUtility.OpenFilePanel(nameof(ImportCsvFile), Application.dataPath, _config.stringExternalLoader.JsonFileInfo.fileExtension[1..]);
            if (string.IsNullOrWhiteSpace(path))
                return;
        ...
        {
            var path = EditorUtility.SaveFilePanel(nameof(ExportCsvFile), Application.dataPath, _target.name, _config.stringExternalLoader.CsvFileInfo.fileExtension[1..]);
            if (string.IsNullOrWhiteSpace(path))
                return;
        ...
        {
            var path = EditorUtility.SaveFilePanel(nameof(ExportCsvFile), Application.dataPath, _target.name, _config.stringExternalLoader.ExcelFileInfo.fileExtension[1..]);
            if (string.IsNullOrWhiteSpace(path))
                return;
        ...
        {
            var path = EditorUtility.SaveFilePanel(nameof(ExportCsvFile), Application.dataPath, _target.name, _config.stringExternalLoader.JsonFileInfo.fileExtension[1..]);
            if (string.IsNullOrWhiteSpace(path))
                return;
