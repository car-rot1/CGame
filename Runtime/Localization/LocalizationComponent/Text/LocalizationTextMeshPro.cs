...
{
    [AddComponentMenu("Localization/LocalizationTextMeshPro")]
    public class LocalizationTextMeshPro : TextMeshPro
    {
        private class LocalizationTextPreprocessor : ITextPreprocessor
        {
            private readonly LocalizationTextMeshPro _target;
            
            public LocalizationTextPreprocessor(LocalizationTextMeshPro target)
            {
                _target = target;
            }
        ...
        public LocalizationTextMeshPro()
        {
